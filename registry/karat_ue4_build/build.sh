...
## @file
# Build the KaRaT UE4 local build with source code image.
#
...
docker build registry/karat_ue4_build\
    --tag karat_ue4_build:${UBUNTU_TAG}_${UE4_VER_TAG}\
    --build-arg BUILDIMAGE=karat_ue4_source:${UBUNTU_TAG}_${UE4_VER_TAG}\
